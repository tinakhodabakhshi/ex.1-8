...
*/
const characters = ["Luke", "Leia", "Han", "Leia", "Rey", "Han"];
const femaleCharacters = ["Leia", "Rey"];

console.log("Length prima dell'operazione:", characters.length);

for (let i = 0; i < femaleCharacters.length; i++) {
  const nameToRemove = femaleCharacters[i];
...
console.log("Length dopo l'operazione:", characters.length);
